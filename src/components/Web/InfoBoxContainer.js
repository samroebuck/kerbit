...
const boxes = [
    ...
    {id: 2, image: download, alt: 'Download icon', class: 'steps__box steps__box--second', content: 'Swipe down to use the camera full screen'},
    {id: 3, image: picture, alt: 'Picture icon', class: 'steps__box steps__box--third', content: 'Snap a photo of your item'},
    {id: 4, image: recycle, alt: 'Recycling icon', class: 'steps__box steps__box--fourth', content: 'Kerbit will let you know if you can recycle it'},
];
