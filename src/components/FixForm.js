...
const FixForm = props => {
  return (
    ...
    <form name='kerbit-wrong' netlify='true' >
      ...
      <label htmlFor='right' className='form__rightlabel'>It was actually:</label>
      <input className='form__rightinput' type='text' name='right' required />

      <label htmlFor='message' className='form__extralabel'>Any extra info?</label>
      <textarea className='form__extrainfo' name='message' rows='3'></textarea>
